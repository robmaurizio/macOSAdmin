...
# Service branding, please see the Customized Self Service Branding area below
  BANNER_IMAGE_PATH="/Library/Application Support/JAMF/hWInternalSSIcon.png"
...
# run in order as they appear below.
  POLICY_ARRAY=(
    ...
    "Creating administrator accounts...,Create-hwadminAccount"
#    "Installing anti-malware software...,Install-CrowdstrikeFalcon"
    "Installing backup software...,Install-Backblaze"
