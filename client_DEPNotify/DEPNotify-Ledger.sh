...
# run in order as they appear below.
  POLICY_ARRAY=(
    ...
    "Creating administrator accounts...,Create-ledgermanageAccount"
    "Creating administrator accounts...,Create-pointmanageAccount"
    ...
    "Prepaing for the next login...,Dock-JamfSelfService"
