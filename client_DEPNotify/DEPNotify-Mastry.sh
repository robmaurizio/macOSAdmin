...
# Update the variable below replacing "email helpdesk@company.com" with the actual plaintext instructions for your organization. Example "call 555-1212" or "email helpdesk@company.com"
  SUPPORT_CONTACT_DETAILS="email support@point.co"
...
# quotes below as double quotes will break the new lines.
  MAIN_TEXT='Your computer will need about an hour to get ready.\n \n Please connect to power and do NOT close the lid or shut down.'

# Initial Start Status text that shows as things are firing up
  INITAL_START_STATUS="Initializing configuration..."

# Text that will display in the progress bar
  INSTALL_COMPLETE_TEXT="Complete!"
...
# deferred enablement is detected. Text displayed if deferred status is on.
  # Option for dropdown alert box
    FV_ALERT_TEXT="Your computer must logout to start the encryption process. Click Enable Now after entering your login password."
  # Options if not using dropdown alert box
    FV_COMPLETE_MAIN_TEXT='Your computer must logout to start the encryption process. Click Enable Now after entering your login password.'
    FV_COMPLETE_BUTTON_TEXT="Logout"

# Text that will display inside the alert once policies have finished
  # Option for dropdown alert box
    COMPLETE_ALERT_TEXT="Your computer is finished with intial configuration. Press Quit to get started!"
  # Options if not using dropdown alert box
    COMPLETE_MAIN_TEXT='Your computer is finished with initial configuration.'
...
# Help Button Configuration
  # The help button was changed to a popup. Button will appear if title is populated.
    HELP_BUBBLE_TITLE="What is happening right now?"
    HELP_BUBBLE_BODY="Scripts to install applications and configure settings are running to ensure your machine is a model $ORG_NAME citizen. Time to completion will vary based on your internet speed.\n \n If something goes wrong or your have questions about computer configuration, please $SUPPORT_CONTACT_DETAILS. \n \nThe FileVault Encryption process will begin after this setup completes."
...
# Main heading that will be displayed under the image
  ERROR_BANNER_TITLE="Uh oh, there was an error!"

# Paragraph text that will display under the main heading. For a new line, use \n
# If this variable is left blank, the generic message will appear. Leave single
# quotes below as double quotes will break the new lines.
	ERROR_MAIN_TEXT='We are sorry that you are experiencing this inconvenience.\n \n Please contact IT right away and we will take a look at your computer ASAP. \n \n'	
...
# run in order as they appear below.
  POLICY_ARRAY=(
    "Installing required frameworks...,Install-Rosetta2"
    "Naming computer...,Set-ComputerName"
    "Gathering info...,Update-ComputerInventory"
    "Installing remote assistance...,Install-ConnectWiseControl"
    "Registering with fleet health...,Install-Watchman"
    "Creating administrator accounts...,Create-mavadminAccount"
    "Creating administrator accounts...,Create-pointadminAccount"
    "Installing Adobe Reader...,Install-AdobeReader"
    "Installing Google Chrome...,Install-googlechrome"
    "Installing Google Drive...,Install-googledrive"
    "Installing Keybase...,Install-Keybase"
    "Installing LastPass...,Install-LastPass"
    "Installing Microsoft Excel...,Install-microsoftexcel"
    "Installing Microsoft OneNote...,Install-microsoftonenote"
    "Installing Microsoft Outlook...,Install-microsoftoutlook"
    "Installing Microsoft PowerPoint...,Install-microsoftpowerpoint"
    "Installing Microsoft Word...,Install-microsoftword"
    "Installing Microsoft Slack...,Install-slack"
    "Installing Microsoft Zoom...,Install-zoom"
    ...
    "Exchanging information with the server...,Update-ComputerInventory"
    "Application deployments - this may take some time...,Update-Policy"
