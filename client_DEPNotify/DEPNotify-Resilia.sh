...
# Service branding, please see the Customized Self Service Branding area below
  BANNER_IMAGE_PATH="/Library/Application Support/JAMF/ResiliaSSIcon.png"
...
# quotes below as double quotes will break the new lines.
  MAIN_TEXT='Your computer will need about 45 minutes to get ready.\n \n Please connect to power and do NOT close the lid or shut down.'
...
# run in order as they appear below.
  POLICY_ARRAY=(
    ...
    "Creating administrator accounts...,Create-resmanageAccount"
    "Creating administrator accounts...,Create-pointadminAccount"
    "Installing anti-malware software...,Install-SentinelOne"
