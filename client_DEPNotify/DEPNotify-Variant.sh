...
# Service branding, please see the Customized Self Service Branding area below
  BANNER_IMAGE_PATH="/Library/Application Support/JAMF/VariantSSIcon.png"
...
# quotes below as double quotes will break the new lines.
  MAIN_TEXT='Your computer will need about 40 minutes to get ready.\n \n Please connect to power and do NOT close the lid or shut down.'
...
# run in order as they appear below.
  POLICY_ARRAY=(
    ...
    "Creating administrator accounts...,Create-variantjamf"
    "Creating administrator accounts...,Create-pointjamf"
    "Installing anti-malware software...,Install-JamfProtect"
    ...
    "Please allow another few moments for final setup tasks...,Update-Policy"
